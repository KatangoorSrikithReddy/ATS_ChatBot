...
export default function ChatDrawer({ handleDrawerOpen, openChatDrawer, setUser, selectedUser }) {
  console.log("this is chatdrawerdata", selectedUser)
  ...
  console.log("this is set serach id", search)
  ...
  return (
    ...
    >
      <MainCard
        sx={{ bgcolor: matchDownLG ? 'transparent' : drawerBG, borderRadius: '12px 0 0 12px', borderRight: 'none',  border: 'none', // Removes any internal border
          boxShadow: 'none' }}
        border={!matchDownLG}
        content={false}
      ...
      >
        ...
        >
          <Stack spacing={2}>
           ...
           <Box  onClick={handleDrawerOpen} sx={{ flexGrow: 1 }}>
            <svg
                width="26"
                height="26"
                viewBox="0 0 24 24"
